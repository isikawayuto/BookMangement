...
/**
 * Servlet implementation class RegisterBookConfirm
 */
@WebServlet("/RegisterBookConfirm")
public class RegisterBookConfirm extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegisterBookConfirm() {
        super();
